---
title: "Immigrant and Crime Data Analysis"
...
LA_council_districts<-read.csv("~/R/Project 15/Datasets/Council Districts.csv")
...
crime_data_2010<-read.csv("~/R/Project 15/Datasets/CrimeData/CrimeDataDistrict_2010.csv")
crime_data_2011<-read.csv("~/R/Project 15/Datasets/CrimeData/CrimeDataDistrict_2011.csv")
crime_data_2012<-read.csv("~/R/Project 15/Datasets/CrimeData/CrimeDataDistrict_2012.csv")
crime_data_2013<-read.csv("~/R/Project 15/Datasets/CrimeData/CrimeDataDistrict_2013.csv")
crime_data_2014<-read.csv("~/R/Project 15/Datasets/CrimeData/CrimeDataDistrict_2014.csv")
crime_data_2015<-read.csv("~/R/Project 15/Datasets/CrimeData/CrimeDataDistrict_2015.csv")
crime_data_2016<-read.csv("~/R/Project 15/Datasets/CrimeData/CrimeDataDistrict_2016.csv")
...
list_council_district_names<-c(immigrant_data_2010 %>% arrange(district) %>% group_by(district) %>% select(name) %>% distinct() %>% ungroup())
...
final_data<-data_frame_for_leaflet %>% gather(key = variable,value = value, -c("X1","DISTRICT","name")) %>% mutate_all(funs(ifelse(is.na(.), 0, .)))
saveRDS(final_data,"~/R/Project 15/Data/Data_for_map.rds")

saveRDS(crime_data_2010[sample(0:nrow(crime_data_2010),1000),],"~/R/Project 15/Data/crime2010.rds")
saveRDS(crime_data_2011[sample(0:nrow(crime_data_2011),1000),],"~/R/Project 15/Data/crime2011.rds")
saveRDS(crime_data_2012[sample(0:nrow(crime_data_2012),1000),],"~/R/Project 15/Data/crime2012.rds")
saveRDS(crime_data_2013[sample(0:nrow(crime_data_2013),1000),],"~/R/Project 15/Data/crime2013.rds")
saveRDS(crime_data_2014[sample(0:nrow(crime_data_2014),1000),],"~/R/Project 15/Data/crime2014.rds")
saveRDS(crime_data_2015[sample(0:nrow(crime_data_2015),1000),],"~/R/Project 15/Data/crime2015.rds")
saveRDS(crime_data_2016[sample(0:nrow(crime_data_2016),1000),],"~/R/Project 15/Data/crime2016.rds")
```

##Further Analysis on Crime Rate
...
crime_rate<-crime_rate %>% select("X1","district","freq"="rate")
```
...
regression_hispanic_abroad<-left_join(regression_hisp_abroad,crime_rate,by=c("X1","district"))
...
regression_hispanic_state<-left_join(regression_hisp_state,crime_rate,by=c("X1","district"))
...
regression_hispanic<-left_join(regression_hispanic,crime_rate,by=c("X1","district"))
...
regression_asian_abroad<-left_join(regression_asian_abroad,crime_rate,by=c("X1","district"))
...
regression_black_abroad<-left_join(regression_black_abroad,crime_rate,by=c("X1","district"))
...
regression_white_abroad<-left_join(regression_white_abroad,crime_rate,by=c("X1","district"))
...
regression_high_abroad<-left_join(regression_high_abroad,crime_rate,by=c("X1","district"))
...
regression_college_abroad<-left_join(regression_college_abroad,crime_rate,by=c("X1","district"))
...
regression_bbachelor_abroad<-left_join(regression_bachelor_abroad,crime_rate,by=c("X1","district"))
...
regression_graduate_abroad<-left_join(regression_graduate_abroad,crime_rate,by=c("X1","district"))
...
regression_poverty100_abroad<-left_join(regression_poverty100_abroad,crime_rate,by=c("X1","district"))
...
regression_poverty149_abroad<-left_join(regression_poverty149_abroad,crime_rate,by=c("X1","district"))
...
regression_poverty150_abroad<-left_join(regression_poverty150_abroad,crime_rate,by=c("X1","district"))
...
regression_population_abroad<-left_join(regression_population_abroad,crime_rate,by=c("X1","district"))
